...
$sql="INSERT INTO signup(name,mobileno,email,password,type) VALUES ('$name',$mobileno,'$email','$password','user')";
...
$conn2->query("INSERT INTO $tablename VALUES ('$d','9090123445','Bonous',500,500) ");
        ...
        <div id="login" >
            ...
            <div id="login_main" >
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id ="login_form" method="POST">
                                    ...
                                    <strong><label for="mobileno">Mobile NO <sup><span class="warning">* </span></sup>: <input type="text" name="mobileno" id='mobileno'  placeholder="9876543210" > </label></strong>
                                    <br>
